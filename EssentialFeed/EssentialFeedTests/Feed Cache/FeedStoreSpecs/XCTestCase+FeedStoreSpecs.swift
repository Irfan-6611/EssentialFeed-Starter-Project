...
//  EssentialFeedTests
//
//  Created by Irfan Ahmed on 23/12/2024.
//
...
extension FeedStoreSpecs where Self: XCTestCase {
    ...
    func expect(_ sut: FeedStore, toRetrieve expectedResult: FeedStore.RetrievalResult, file: StaticString = #filePath,
        ...
        sut.retrieve { retrievedResult in
            ...
            case let (.success(expectedCacheFeed), .success(retrievedCacheFeed)):
                XCTAssertEqual(expectedCacheFeed?.feed, retrievedCacheFeed?.feed, file: file, line: line)
                XCTAssertEqual(expectedCacheFeed?.timestamp, retrievedCacheFeed?.timestamp, file: file, line: line)
